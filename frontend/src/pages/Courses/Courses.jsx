...
// import { CoursesView } from "@/components/sections";

// temporary data for upcoming courses
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="relative bg-bg-card rounded-2xl border border-border p-8 sm:p-12 text-center mb-10 overflow-hidden">
        ...
        <p className="text-fg-secondary text-base sm:text-lg leading-relaxed max-w-2xl mx-auto mb-8">
          I'm working hard to create high-quality, comprehensive courses that
          will help you level up your programming skills. Stay tuned for
          structured learning paths, hands-on projects, and in-depth tutorials.
        </p>
...
const Courses = () => {
  const meta = getPageMeta("courses");
